              ...
              <article class="media">
                <div class="media-left">
                  <figure class="image is-64x64 ">
                    <img
                      src="../assets/img/twitter-profile-guy.jpg"
                      alt="Image"
                    />
                  </figure>
                </div>
                <div class="media-content">
                  <div class="content">
                    <p>
                      ...
                      <small>5m</small>
                      <br />
                      Frist time I used @fancyapp, was like the first time I
                      listened to The Beatles. Christmas came early, I guess.
                    </p>
                  </div>
            ...
            <div class="box">
              <article class="media">
                <div class="media-left">
                  <figure class="image is-64x64 ">
                    <img
                      src="../assets/img/twitter-profile-girl.jpg"
                      alt="Image"
                    />
                  </figure>
                </div>
                <div class="media-content">
                  <div class="content">
                    <p>
                      ...
                      <small>5m</small>
                      <br />
                      Fancy App is the answer to all your problems, all praise
                      the #fancyappgod!
                    </p>
                  </div>
                  <nav class="level is-mobile">
    ...
    <section id="features" class="section has-mustard-bg">
      <div class="container">
        <div class="columns">
          ...
          <div class="column">
            <h3 class="is-size-3">
              One resume. available Everywhere
            </h3>
      ...
      <div class="container">
        <div class="columns">
          <div class="column">
            ...
            <p class="has-text-green paragraph">
              The world runs on open source and so do we here at globalcv. We
              release all of the code
            </p>
          </div>
          <div class="column">
            <img
